(function () {
  ...
  class Vidas {
    ...
    constructor () {
      let life_tree = document.createElement("div");
      life_tree.id = "tree";
      life_tree.style.display = "inline";

      for(let i = 0; i < 5; i++){
        let set_vidas = document.createElement("div");      
        set_vidas.className = "vidas";
        life_tree.appendChild(set_vidas);
        vidasAux.push(set_vidas);
      }

      document.getElementById("ponto").appendChild(life_tree);
    }
  ...
  class Pontuacao {
    ...
    constructor () {
      ...
      document.getElementById("ponto").appendChild(this.element);
    }
  }
  ...
  function incrementa_ponto(valor){
    ...
    var pontuacao = document.getElementById("ponto");
